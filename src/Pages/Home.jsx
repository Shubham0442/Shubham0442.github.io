  ...
  return (
    <Box>
      <Flex
        ...
        alignItems={"center"}
        gap={{ base: "25px" }}
        mt={{ base: "80px", sm: "80px", md: "80px" }}
      >
        <Box
          w={{ base: "250px", sm: "300px", md: "400px", lg: "450px" }}
          textAlign={"left"}
        >
          <Text
            color={"#ff6263"}
            fontSize={{ base: "40px", sm: "40px", md: "50px", lg: "55px" }}
            fontWeight={"700"}
          >
            Hi,👋
          </Text>
          <Text
            fontSize={{ base: "22px", sm: "25px", md: "30px", lg: "35px" }}
            fontWeight={"700"}
          >
            I'm Shubham Rakhonde
          </Text>
          <Text
            color={"#ef234b"}
            fontSize={{ base: "18px", sm: "18px", md: "23px", lg: "28px" }}
            fontWeight={"700"}
          >
            <Typewriter
              options={{
          ...
          >
            ...
            <a href="https://medium.com/@shubhamrakhonde507" target={"_blank"} rel="noreferrer">
              <Box h={"25px"} w={"25px"}>
                <Image
        ...
        <Box>
          <Image
            w={{ base: "300px", sm: "350px", md: "400px", lg: "460px" }}
            src="/sitePhotos/2022-07-26 (1).png"
            alt="pic"
          />
        </Box>
      </Flex>
