  ...
  return (
    ...
    <Box w={"100%"} h={"600px"} m={"auto"} bg={"#e0e5e9"}>
         ...
         <Box w={{ base:"80%", sm:"80%", md:"70%", lg:"60%"}} m={"auto"} textAlign={"left"}>
            <Box w={"50%"} m={"auto"}>
              <Image w={"100%"} h={{ base: "150px", sm:"200px", md:"200px", lg:"250px"}} borderRadius={"50%"} src= {"https://www.foxtraut.com/images/php-development-banner.png"} alt={"about"}/>
            </Box>
            <Box>
